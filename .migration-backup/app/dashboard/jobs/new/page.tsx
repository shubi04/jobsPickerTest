...
export default function NewJobPage() {
  ...
  const checkEmployerProfile = async () => {
    ...
    setEmployerProfileId(employerProfile.id);
    setIsLoading(false);
  };
  ...
  return (
    <div className="container py-8 max-w-3xl">
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div className="flex flex-wrap gap-2 mb-4">
            {skills.map((skill, i) => (
              ...
              >
                ...
                <button
                  type="button"
                  onClick={() => removeFromArray(i, skills, setSkills)}
          ...
          <div className="flex gap-2">
            <input
              ...
              onKeyPress={(e) =>
                e.key === "Enter" &&
                (e.preventDefault(),
                addToArray(newSkill, skills, setSkills, setNewSkill))
              }
            ...
            <button
              ...
              className="inline-flex h-10 items-center justify-center gap-1 rounded-md border border-border bg-background px-3 text-sm font-medium hover:bg-muted"
            >
          ...
          <ul className="space-y-2 mb-4">
            {requirements.map((req, i) => (
              ...
              >
                ...
                <button
                  type="button"
                  onClick={() => removeFromArray(i, requirements, setRequirements)}
        ...
        {/* Responsibilities */}
        <div className="rounded-lg border border-border bg-card p-6">
          <h2 className="font-semibold mb-4">Responsibilities</h2>
          <ul className="space-y-2 mb-4">
            {responsibilities.map((resp, i) => (
              ...
              >
                ...
                <button
                  type="button"
                  onClick={() =>
                    removeFromArray(i, responsibilities, setResponsibilities)
                  }
                  className="text-muted-foreground hover:text-destructive"
                >
                  <X className="h-4 w-4" />
        ...
        <div className="rounded-lg border border-border bg-card p-6">
          ...
          <div className="flex flex-wrap gap-2 mb-4">
            {benefits.map((benefit, i) => (
              <span
                key={i}
                className="inline-flex items-center gap-1 rounded-full bg-success/10 px-3 py-1 text-sm font-medium text-success"
              >
                {benefit}
                <button
                  type="button"
                  onClick={() => removeFromArray(i, benefits, setBenefits)}
                  className="ml-1 hover:text-destructive"
                >
                  <X className="h-3 w-3" />
                </button>
          ...
          <div className="flex gap-2">
            <input
              ...
              onKeyPress={(e) =>
                e.key === "Enter" &&
                (e.preventDefault(),
                addToArray(newBenefit, benefits, setBenefits, setNewBenefit))
              }
              className="flex-1 rounded-md border border-input bg-background px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-ring"
            />
            <button
