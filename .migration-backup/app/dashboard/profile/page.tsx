...
import { User, MapPin, Briefcase, Link as LinkIcon, Save, Loader2, Plus, X } from "lucide-react";
...
export default function ProfilePage() {
      ...
      if (existing) {
        ...
        const { error: jsError } = await supabase
          ...
          .update({
            ...
            expected_salary: jobseekerProfile?.expected_salary,
  ...
  const removeSkill = (skillToRemove: string) => {
    if (jobseekerProfile) {
      setJobseekerProfile({
        ...jobseekerProfile,
        skills: jobseekerProfile.skills.filter((s) => s !== skillToRemove),
      });
    }
  };
      ...
      <form onSubmit={handleSave} className="space-y-8">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <div>
              ...
              <input
                ...
                value={jobseekerProfile?.expected_salary || ""}
                onChange={(e) =>
                  setJobseekerProfile({
                    ...jobseekerProfile!,
        ...
        <div className="rounded-lg border border-border bg-card p-6">
          ...
          <textarea
            ...
            onChange={(e) =>
              setJobseekerProfile({ ...jobseekerProfile!, bio: e.target.value })
            }
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <div>
              ...
              <input
                ...
                value={jobseekerProfile?.linkedin_url || ""}
                onChange={(e) =>
                  setJobseekerProfile({
                    ...jobseekerProfile!,
            ...
            <div>
              ...
              <input
                ...
                value={jobseekerProfile?.portfolio_url || ""}
                onChange={(e) =>
                  setJobseekerProfile({
                    ...jobseekerProfile!,
