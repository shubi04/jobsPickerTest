      ...
      <section className="border-b border-border bg-muted/30 py-12">
        <div className="container">
          ...
          <p className="mt-2 text-muted-foreground">
            Browse {jobs?.length || 0}+ jobs from top companies
          </p>
        </div>
      </section>
      ...
      <section className="py-8">
        <div className="container">
              ...
              jobs.map((job) => (
                ...
                >
                  <div className="flex items-start justify-between gap-4">
                    ...
                    <Link
                      href="/auth/signup"
                      className="inline-flex h-9 items-center justify-center gap-1 rounded-md bg-primary px-4 text-sm font-medium text-primary-foreground hover:bg-primary/90"
                    >
                      Apply
          ...
          <div className="mt-12 rounded-lg bg-primary/5 p-8 text-center">
            ...
            <p className="mt-2 text-muted-foreground">
              Create a free account to apply to any job and track your
              applications.
            </p>
            <Link
              href="/auth/signup"
